# Documento de Inducción a la Empresa
...
Conocer la empresa **FeelTheTickets (FTT)**, su modelo de negocio, la estructura del equipo con el que se trabajará durante la pasantía, y el alcance general del proyecto en el que se participará.
...
| Rol | Descripción |
|---|---|
| Tutor empresarial | Miguel Vivanco — Supervisa el proyecto, valida requerimientos y prioridades del negocio |
| Jefe / Administrador | Rol dentro del sistema con acceso total: dashboard, gestión de usuarios, auditoría y canje |
| Staff / Operador | Rol dentro del sistema encargado de la atención en punto de venta: búsqueda y canje de boletos |
...
- Datos de venta entregados en formato **CSV** (exportado de la plataforma de venta de entradas).
- Necesidad de un sistema propio para digitalizar el canje (no se usa un software de terceros para esta etapa).

## 7. Conclusiones del día

- Se comprendió el contexto de negocio de FTT y la importancia del proceso de canje como punto crítico de la experiencia del cliente el día del evento.
