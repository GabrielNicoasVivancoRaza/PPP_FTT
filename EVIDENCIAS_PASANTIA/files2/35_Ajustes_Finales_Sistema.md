...
| RNF-03 | Rate limiting global de peticiones por IP | Caso PB-01 (Día 32): ráfaga de más de 200 peticiones/minuto desde la misma IP devuelve 429; el límite aplica globalmente a todas las rutas, no solo a las de autenticación |
